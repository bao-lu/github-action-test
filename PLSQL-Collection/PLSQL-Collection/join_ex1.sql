...
select G1.Gadget_ID,g1.gadget_name from Gadget G1,GADGET G2 where G1.PRICE <  G2.PRICE and G2.Gadget_ID = 40679; -- select all rows whose  price is less than that of SAMSUNG S3;t_ID number(5) PRIMARY KEY,
gadget_name varchar2(10),
price number(8,2),
company_id number(6)
);
...
select G1.Gadget_ID,g1.gadget_name from Gadget G1,GADGET G2 where G1.PRICE = G2.PRICE and G2.Gadget_ID = 40689; -- select all rows whose price is equal to that of NOKIA 2330;
select G1.Gadget_ID,g1.gadget_name from Gadget G1,GADGET G2 where G1.PRICE <  G2.PRICE and G2.Gadget_ID = 