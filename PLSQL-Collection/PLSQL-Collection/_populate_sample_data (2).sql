...
COMMIT;
 ...
 WHERE app_cd = 'CORE'), 'Ad-Hoc Msg', 'None.', 'This empty message is not meant to be seen. If users are calling logs.msg without a msg_cd, then this msg_cd will be used and whatever they pass in will be the message.');
...
INSERT INTO app_msg (MSG_ID, APP_ID, MSG_CD, MSG, MSG_DESCR)
VALUES (102, (SELECT app_id FROM app WHERE app_cd = 'CORE'), 'Logical Lock Held', 'Lock on @1@ already held by @2@. Try again later.','1=table