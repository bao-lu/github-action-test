...
/
ber default NULL, layout in string default NULL, output in string default NULL, identifier in string default NULL);
   ...
   */        
  procedure debug (text in string, args in StringList default new StringList());
  procedure info (text in string, args in StringList default